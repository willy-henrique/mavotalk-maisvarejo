...
import { productSalesPayloadSchema } from "@/lib/agent-cloud/agent-payload-schemas";
...
export async function POST(request: Request) {
  const auth = await authenticatedAgentPayload(request, productSalesPayloadSchema);
