import { producaoPorAtendente } from "@/lib/metrics/agents";
...
export async function GET(request: Request) {
  ...
  try {
    ...
    const data = await producaoPorAtendente(session.organizationId, periodo, filtros);
    ...
    return metricsError("internal", "Não foi possível calcular a produção da equipe");
  }
}
