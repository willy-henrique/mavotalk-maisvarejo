...
import { metricasPorFila } from "@/lib/metrics/queues";
...
export async function GET(request: Request) {
  ...
  try {
    ...
    const data = await metricasPorFila(session.organizationId, periodo, filtros);
    ...
    return metricsError("internal", "Não foi possível calcular as métricas por fila");
  }
}
