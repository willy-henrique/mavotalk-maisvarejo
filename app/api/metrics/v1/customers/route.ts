import { metricasPorCliente } from "@/lib/metrics/customers";
...
export async function GET(request: Request) {
  ...
  try {
    ...
    const data = await metricasPorCliente(session.organizationId, periodo, filtros);
    ...
    return metricsError("internal", "Não foi possível analisar os clientes");
  }
}
