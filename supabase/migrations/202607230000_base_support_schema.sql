-- Baseline idempotente do domínio de atendimento existente.
-- Permite aplicar as migrations do Mavo Talk em um projeto Supabase vazio sem
-- alterar ou remover dados de uma instalação já existente.
-- Rollback: não é automatizado porque estas tabelas podem conter atendimento
-- histórico. Em banco descartável, remova-as na ordem inversa das FKs.
BEGIN;
...
DO $$ BEGIN
  CREATE TYPE conversation_status AS ENUM (
    'aguardando', 'em_atendimento', 'pendente_cliente', 'encerrado'
  );
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;
