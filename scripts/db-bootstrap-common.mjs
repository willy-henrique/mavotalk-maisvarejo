export function defaultOrganizationConfig() {
...
export async function bootstrapDefaultOrganization(client) {
  const { organizationId, organizationName } = defaultOrganizationConfig();
  try {
