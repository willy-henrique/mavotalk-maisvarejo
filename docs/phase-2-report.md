...
- Agentes e sincronização passou a buscar por instalação e filtrar estados online, com atenção ou revogado no servidor, preservando o escopo da organização.
