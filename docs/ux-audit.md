...
| P2 | Primitives compartilhadas incompletas | Tokens, `Dialog`, paginação, páginas, cards, botões, campos, estados de loading/vazio/erro e `StatusBadge` foram centralizados; tabelas, filtros e badges nas listas ainda variam entre Equipe, Filas, Acessos, Agentes e Respostas rápidas. |
