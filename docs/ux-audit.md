...
| P2 | Primitives compartilhadas incompletas | Tokens, `Dialog`, paginação, páginas, cards, botões, campos, estados de loading/vazio/erro e `StatusBadge` foram centralizados; Contatos, Filas, Auditoria, Acessos e Agentes usam o badge compartilhado, enquanto tabelas, filtros e badges ainda variam entre Equipe e Respostas rápidas. |
