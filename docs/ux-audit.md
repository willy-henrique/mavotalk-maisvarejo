...
| Resolvido | Contatos transferia o tenant inteiro para filtrar no navegador | Busca e paginação agora são server-side, com consulta RLS estrita e somente a última interação de cada contato na página exibida. |
