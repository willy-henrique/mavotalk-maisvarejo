...
| P2 | Primitives compartilhadas incompletas | Tokens, `Dialog`, paginação, páginas, cards, botões, campos, estados de loading/vazio/erro e `StatusBadge` foram centralizados; Contatos e Filas usam o badge compartilhado, enquanto tabelas, filtros e badges ainda variam entre Equipe, Acessos, Agentes e Respostas rápidas. |
