...
| P2 | Fluxos administrativos têm feedback desigual | Dashboard, Central de conexão, Equipe e Filas expõem loading e falhas de carregamento com tentativa novamente; outras ações ainda não oferecem confirmação, prevenção uniforme de duplo envio, confirmação destrutiva ou aviso de alterações não salvas. |
