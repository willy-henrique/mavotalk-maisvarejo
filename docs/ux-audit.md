...
| P2 | Primitives compartilhadas incompletas | Tokens, `Dialog`, paginação, páginas, cards, botões, campos, estados de loading/vazio/erro e `StatusBadge` foram centralizados; Contatos, Filas, Auditoria, Acessos, Agentes e Equipe usam o badge compartilhado. As tabelas, filtros e metadados de Respostas rápidas ainda precisam ser enriquecidos com dados que a API atual não expõe. |
